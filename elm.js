...
Elm.Fs = Elm.Fs || {};
Elm.Fs.make = function (_elm) {
   "use strict";
   _elm.Fs = _elm.Fs || {};
   if (_elm.Fs.values) return _elm.Fs.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var $default = {name: "",extension: "",contents: ""};
   var File = F3(function (a,b,c) {    return {name: a,extension: b,contents: c};});
   var decoder = A2($Json$Decode$Extra._op["|:"],
   A2($Json$Decode$Extra._op["|:"],
   A2($Json$Decode$Extra._op["|:"],$Json$Decode.succeed(File),A2($Json$Decode._op[":="],"name",$Json$Decode.string)),
   A2($Json$Decode._op[":="],"extension",$Json$Decode.string)),
   A2($Json$Decode._op[":="],"contents",$Json$Decode.string));
   var decode = function (value) {    return A2($Result.withDefault,$default,A2($Json$Decode.decodeValue,decoder,value));};
   return _elm.Fs.values = {_op: _op,File: File,$default: $default,decoder: decoder,decode: decode};
};
Elm.PackageJson = Elm.PackageJson || {};
Elm.PackageJson.make = function (_elm) {
   "use strict";
   _elm.PackageJson = _elm.PackageJson || {};
   ...
   var stringOrKeyValue = $Json$Decode.oneOf(_U.list([A2($Json$Decode.map,
                                                     function (n) {
                                                        return {ctor: "_Tuple2",_0: baseName(n),_1: n};
                                                     },
                                                     $Json$Decode.string)
                                                     ,A2($Json$Decode.map,
                                                     function (n) {
   ...
   var repositoryDecoder = $Json$Decode.oneOf(_U.list([A2($Json$Decode.map,function (n) {    return {ctor: "_Tuple2",_0: "git",_1: n};},$Json$Decode.string)
                                                      ,A3($Json$Decode.object2,
                                                      F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};}),
                                                      A2($Json$Decode._op[":="],"type",$Json$Decode.string),
                                                      A2($Json$Decode._op[":="],"url",$Json$Decode.string))]));
   var defaultPerson = {name: $Maybe.Nothing,email: $Maybe.Nothing,url: $Maybe.Nothing};
   var $default = {name: $Maybe.Nothing
                  ,version: $Maybe.Nothing
                  ,description: $Maybe.Nothing
                  ,keywords: $Maybe.Nothing
                  ,homepage: $Maybe.Nothing
                  ,bugs: $Maybe.Nothing
                  ,license: $Maybe.Nothing
   ...
   var packageJsonDecoder = A2($Json$Decode$Extra._op["|:"],
   A2($Json$Decode$Extra._op["|:"],
   A2($Json$Decode$Extra._op["|:"],
   A2($Json$Decode$Extra._op["|:"],
   A2($Json$Decode$Extra._op["|:"],
   ...
   $Json$Decode.maybe(A2($Json$Decode._op[":="],"keywords",$Json$Decode.list($Json$Decode.string)))),
...
Elm.HotRod.make = function (_elm) {
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $PackageJson = Elm.PackageJson.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $String = Elm.String.make(_elm);
   var _op = {};
   var fetchFileBox = $Signal.mailbox("");
   var linkFieldView = F2(function (key,url) {
      return A2($Html.div,
   ...
   var packageJsonView = function (pj) {
      ...
      var fields = _U.list([A3(kvDiv,"Name",stringValue,pj.name)
                           ...
                           ,A3(kvDiv,"Home Page",linkValue,pj.homepage)
                           ,A3(kvDiv,"Bugs",stringValue,pj.bugs)
                           ,A3(kvDiv,"License",stringValue,pj.license)
                           ,A3(kvDiv,"Author",personValue,pj.author)
                           ,A3(kvDiv,"Contributors",listValue(personValue),pj.contributors)
